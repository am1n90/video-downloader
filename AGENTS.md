...
- Тесты задачи: `test_mode_switch.py` 51, `test_close_threads.py` 22,
  `test_torrent_engine.py` 40, живая проверка `check_mode_switch_live.py`.

### Окружение на другой машине (офисная — НЕ готова)
...
- Офисная машина: Python 3.13 и регресс не делались.
